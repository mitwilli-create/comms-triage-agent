...
**For use with:** the internal portal (Chrome Extension)  
...
1. Install the internal portal if not already installed
2. Navigate to target page (the people directory profiles or distribution list)
...
Search across their the people directory profiles, recent documents, presentations, email threads (if visible), and any org announcements they've authored or been mentioned in. Focus on patterns that reveal how they communicate and what they care about.
...
**Navigate to:** Target person's the people directory profiles
...
**Filename format:** 
- For individuals: `[employee-id]@[ORG_DOMAIN].md`
- For groups: `[alias]@[ORG_DOMAIN].md`

**Why save:** The OES Comms Agent checks this folder. Saved summaries can inform future interactions.
...
*These prompts are optimized for the internal portal. They may work with other LLM tools but haven't been tested.*
