...
**Maintainer:** Communications Lead, OES  
...
This guide covers deploying the OES Internal Comms Triage Agent in a Google Workspace environment. The agent runs as a Google Apps Script project, triggered by Google Form submissions, and uses the Gemini API for AI-powered triage, revision, and escalation decisions.
...
- Estimated quota: ~50–100 Gemini API calls/week for typical OES volume
...
var CONFIG = {
  ...
  SENDER_ALIAS:         'oes-comms@domain.com',
