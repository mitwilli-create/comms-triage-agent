...
Factor Assessment:
	...
	•	Scope: Cross-org (multiple OES teams) → M
...
Request: "We need to announce the org restructure to all of OES and communicate changes to partner teams."
